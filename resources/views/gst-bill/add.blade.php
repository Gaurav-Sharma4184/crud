                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label>Party</label>
                                <select class="form-control border-bottom" name = "party-id" id="validationCustom01">
                            ...
                            <ul style="list-style: none;float: right;">
                                <li>
                                    <b>Total Amount:</b> ₹ <span type="text"
                                        id="totalAmountDisplay"></span>
                                </li>
                                <li>
                                    <b>Tax:</b> ₹ <span type="text" id="taxDisplay"></span>
                                    <input type="hidden" value="" name="tax_amount"
                                        id="taxAmount">
                                </li>
                                <li>
                                    <b>Net Amount:</b> ₹ <span type="text"
                                        id="netAmountDisplay">0</span>
                                    <input type="hidden" value="" name="net_amount" id="netAmount">
                                </li>
                            </ul>
                        </div>
                    </div>
