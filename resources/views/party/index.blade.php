                ...
                <div class="col-12">
                    ...
                    <div class="card-box">
                        <a href="{{ route('add-party') }}" class="btn btn-sm btn-blue waves-effect waves-light float-right">
                            <i class="mdi mdi-plus-circle"></i> Add Part
                        </a>
                        <h4 class="header-title mb-4 text-uppercase">Manage Party</h4>
                        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled">
                                            ...
                                            <li><b>Phone No :</b> <span>{{$party->phone_no}}</span></li>
                                    ...
                                    <td>
                                        <ul class="list-unstyled">
                                            ...
                                            <li><b>Account No :</b> <span>{{$party->account_no}}</span></li>
